...
class WhileyCompileOptions {
    ...
    /**
     * The output directory for the {@code wyil} intermediary files.
     * <p>
     * Default: {@code null}.
     */
    @Optional
    ...
    File wyildir
    /**
     * The output directory for the {@code wyal} intermediary files. Note that these files
     * are only generated if {@link #verify} is set to {@code true}.
     * <p>
     * Default: {@code null}.
     */
    @Optional
    ...
    File wyaldir
    /**
     * The output directory for the {@code wycs} intermediary files. Note that these files
     * are only generated if {@link #verify} is set to {@code true}.
     * <p>
     * Default: {@code null}.
     */
