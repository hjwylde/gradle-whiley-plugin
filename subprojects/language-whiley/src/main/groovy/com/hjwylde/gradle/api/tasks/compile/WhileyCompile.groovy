package com.hjwylde.gradle.api.tasks.compile

import com.hjwylde.gradle.api.internal.tasks.compile.DefaultWhileyCompileSpec
import com.hjwylde.gradle.api.internal.tasks.compile.DefaultWhileyCompilerFactory
import com.hjwylde.gradle.api.internal.tasks.compile.DelegatingWhileyCompiler
...
class WhileyCompile extends SourceTask {
    ...
    protected void compile() {
        ...
        def spec = new DefaultWhileyCompileSpec(
